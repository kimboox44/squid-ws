        ...
        try {
            ...
            if (path.contains("faq")) {
                ...
                if (req.getSession(false).getAttribute("user") != null) {
                    ...
                    System.out.println("PATH CONTAINS FAQ HERE >>>>>>>>>> " + user.toString());
                }else{
                    res.getWriter().append("NO SESSION! Please connect");
                    //res.getWriter().append("<a href='/index.jsp'>return</a>");
                    System.out.println("PATH CONTAINS FAQ HERE >>>>>>>>>> NO USER");
                    return;
                }
